...
from .models import Cart, CartItem, Customer, Order, OrderItem, Product, Category, Like
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'slug', 'description', 'price', 'image_url',
                  'stock', 'in_stock', 'is_featured', 'is_bestseller', 'category',
                  'liked_by_user', 'likes_count']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'order_number', 'customer', 'placed_at', 'payment_status', 
                  'payment_method_display', 'delivery_method_display', 'items', 
                  'total', 'address', 'city', 'first_name', 'last_name', 'phone', 'email']
...
class CreateOrderSerializer(serializers.Serializer):
    ...
    first_name = serializers.CharField(max_length=100, allow_blank=True, default='')
    last_name = serializers.CharField(max_length=100, allow_blank=True, default='')
