...
# ---------- DATABASE ----------
# Priority: MYSQL_PRIVATE_URL (Railway private network) > DATABASE_URL > local MySQL
if 'MYSQL_PRIVATE_URL' in os.environ:
    DATABASES = {
        'default': dj_database_url.config(default=os.environ['MYSQL_PRIVATE_URL'], conn_max_age=600)
    }
elif dj_database_url and 'DATABASE_URL' in os.environ:
    DATABASES = {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'magdisbakery_db',
            'USER': 'root',
            'PASSWORD': 'youssef2717',
            'HOST': 'localhost',
            'PORT': '3306',
        }
    }
